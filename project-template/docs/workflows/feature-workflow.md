...
4. Prompt you to pick one and `/plan` it
...
2. Write `docs/plans/rate-limiting.md` with:
   - Summary + approach
...
Claude will:
1. Read `docs/plans/rate-limiting.md`
...
5. Run code-reviewer on changed files when done
...
Claude: [writes docs/plans/usage-dashboard.md]
