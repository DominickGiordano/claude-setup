...
name: database
description: >-
  Areté conventions for queries, migrations and schemas across Postgres/Ecto, Prisma and raw
  SQL: indexes, foreign keys, joins, N+1 avoidance, rollbacks, seed data. Read this before
  writing any migration.
when_to_use: >-
  Triggers: migration, schema, query, ecto, prisma, SQL, index, foreign key, repo, changeset,
  database, N+1, seed data, rollback.
---
