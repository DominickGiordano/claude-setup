...
name: infisical
description: >-
  Areté conventions for Infisical secrets management: CLI usage, SDK integration, injecting
  secrets into services, post-Terraform-apply secret push, new project secret environments,
  rotation.
when_to_use: >-
  Triggers: infisical, secrets, secret management, secret push, secret rotation, vault,
  credentials management, secret paths.
---
