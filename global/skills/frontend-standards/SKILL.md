...
description: >-
  Areté frontend conventions for React, Next.js, Tailwind and shadcn/ui: component structure,
  design system, accessibility, layout, performance. Load alongside ts-component for
  implementation patterns.
when_to_use: >-
  Triggers: react, next.js, tailwind, shadcn, component, UI, layout, styling, accessibility,
  a11y, responsive, design system.
---
