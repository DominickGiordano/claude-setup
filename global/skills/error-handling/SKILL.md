...
name: error-handling
description: >-
  Areté patterns for error handling and propagation in TypeScript, Python and Elixir: typed
  errors, Result types, error boundaries, custom error classes, error codes, HTTP error
  responses.
when_to_use: >-
  Designing how errors surface and propagate. Triggers: error handling, result type, AppError,
  try/catch, with chain, error propagation, typed errors, error boundary, error codes.
---
