...
name: env-config
description: >-
  Areté conventions for environment variables, config loading, secrets injection and
  multi-environment setup: .env files, config validation, runtime config, config schemas.
when_to_use: >-
  Triggers: env, environment variable, config, .env, dotenv, runtime config, config.exs,
  settings, secrets injection, environment-specific behavior.
---
