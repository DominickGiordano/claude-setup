...
name: api-route
description: >-
  Areté conventions for Next.js App Router route handlers and server actions: handler shape,
  request validation, response formatting, middleware.
when_to_use: >-
  Creating or modifying a Next.js API route. Triggers: api route, route handler, server
  action, app/api/, NextRequest, NextResponse, GET/POST/PUT/DELETE handler.
---
