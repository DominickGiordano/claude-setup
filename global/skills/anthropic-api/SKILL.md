...
name: anthropic-api
description: >-
  Areté conventions for calling the Anthropic API and Claude SDK: message shape, streaming,
  tool use, prompt caching, batch API, token counting, agentic loops.
when_to_use: >-
  Writing or debugging any code that calls Claude. Triggers: anthropic, claude api,
  messages.create, tool_use, system prompt, streaming, SDK, batch api, prompt caching, token
  counting.
---
