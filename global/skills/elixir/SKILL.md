...
name: elixir
description: >-
  Areté overlay for Elixir 1.15+: modules, GenServers, supervisors, with chains, pipelines,
  tagged tuples, telemetry. The project's phoenix-framework skill bundles upstream
  usage_rules:elixir for general idioms — this is the addendum.
when_to_use: >-
  Writing Elixir. Load with phoenix for web work, ash for resources, jido-reqllm-tools for
  areteos agents. Triggers: elixir, genserver, supervisor, otp, mix, defmodule, pattern match,
  pipe operator, with chain, tagged tuple, process, task, telemetry.
---
