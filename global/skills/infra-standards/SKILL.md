...
description: >-
  Areté infrastructure conventions for Terraform, AWS, CI/CD, Docker and deploys: IAM, ECS,
  Lambda, GitHub Actions, Fargate. Load alongside terraform and docker-deploy for
  implementation patterns.
when_to_use: >-
  Any infrastructure work. Triggers: infra, infrastructure, aws, iam, ecs, lambda, ci/cd,
  github actions, deploy, cloud, fargate.
---
