...
name: logging
description: >-
  Areté patterns for structured logging and observability in TypeScript (pino), Python and
  Elixir: log levels, request tracing, telemetry, debug output formatting.
when_to_use: >-
  Adding logging or observability to a service. Triggers: logging, logger, pino, log level,
  structured log, observability, telemetry, tracing, debug log.
---
