...
name: mcp-patterns
description: >-
  Building and integrating MCP servers and clients: tool, resource and prompt definitions,
  transport layers, connecting servers to Claude Code, wiring MCP into the Anthropic API.
when_to_use: >-
  Triggers: mcp, model context protocol, mcp server, mcp client, tool definition, mcp
  resource, mcp transport, .mcp.json.
---
