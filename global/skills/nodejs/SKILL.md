...
name: nodejs
description: >-
  Areté conventions for Node.js scripts, servers, CLI tools and utilities: module patterns,
  async, error handling, package.json config, npm scripts, ESM vs CJS.
when_to_use: >-
  Triggers: node, nodejs, npm, package.json, esm, cjs, node script, node server, node cli.
---
