...
name: ios-standards
description: >-
  Areté conventions for iOS and macOS work in Swift 6+: SwiftUI, UIKit, SwiftData, Core Data,
  SPM packages, Xcode project layout, app architecture, observable view models.
when_to_use: >-
  Writing any Swift or SwiftUI. Triggers: swift, swiftui, xcode, ios, macos, uikit, swiftdata,
  spm, apple, view model, observable.
---
