...
name: terraform
description: >-
  Areté conventions for Terraform and Terragrunt: module design, state management, provider
  config, workspaces, AWS resources, IAM roles, OIDC setup, Terraform Cloud.
when_to_use: >-
  Writing, reviewing or debugging any IaC. Triggers: terraform, terragrunt, tf, hcl,
  workspace, state file, provider, module, apply, plan, destroy, tfvars.
---
