...
description: >
  ALWAYS use when doing any frontend work — React, Next.js, Tailwind, shadcn/ui,
  UI components, design systems, accessibility, or performance optimization. Covers
  Areté frontend conventions. Load alongside ts-component for implementation patterns.
  Trigger phrases: "react", "next.js", "tailwind", "shadcn", "component", "UI",
  "layout", "styling", "accessibility", "a11y", "responsive", "design system".
---
