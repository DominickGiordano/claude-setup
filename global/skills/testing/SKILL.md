...
name: testing
description: >-
  Areté test conventions for TypeScript/Jest/Vitest, Python/pytest and Elixir/ExUnit:
  fixtures, mocking, assertions, test structure, CI test config.
when_to_use: >-
  Writing or modifying tests. Triggers: test, jest, vitest, pytest, exunit, mock, fixture,
  assert, describe, it(, test(, factory.
---
