...
name: ts-component
description: >-
  Writing and refactoring typed React components to Areté standards: prop typing, hooks, state
  management, composition.
when_to_use: >-
  Triggers: component, tsx, react component, props, hooks, useState, useEffect, functional
  component.
---
