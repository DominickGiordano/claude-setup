<!--
  Vendored verbatim from https://github.com/kenn-io/constitution @ v2026.08.11
  © 2026 Kenn Software LLC, CC BY 4.0. Do NOT edit the body below — re-vendor
  instead, so the diff against upstream stays readable:

    gh api repos/kenn-io/constitution/contents/CONSTITUTION.md --jq .content \
      | base64 -d > global/rules/constitution.md

  Areté notes live in constitution-local.md, never inline here.
-->
